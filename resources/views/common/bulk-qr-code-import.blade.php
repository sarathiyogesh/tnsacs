		...
		<div class="toolbar" id="kt_toolbar">
			...
			<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
				...
				<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
					<!--begin::Title-->
					<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Import Bulk QR Code</h1>
					<!--end::Title-->
				</div>
				<!--end::Page title-->
				<!--begin::Actions-->
				<div class="d-flex align-items-center gap-2 gap-lg-3">
					...
					<a href="{{ asset('/uploads/sample-qrcodes.xlsx') }}" id="kt_help_toggle" class="btn btn-sm btn-primary" >Sample Excel</a>
				</div>
				<!--end::Actions-->
			</div>
			<!--end::Container-->
			...
			<div id="kt_content_container" class="container-xxl">
				<div class="card card-flush">
					<div class="card-body">
						...
						<form action="{{url('/bulk-qr-codes/import/save')}}" method="POST" enctype="multipart/form-data">
							@csrf
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label class="required form-label">QR Code</label>
										<input type="file" name="qrcode_file" class="form-control mb-2" placeholder="QR Code" value="{{old('qrcode_file')}}">
										@if($errors->has("qrcode_file"))
											<span id="qrcode_file-error" class="help-block">{!! $errors->first("qrcode_file") !!}</span>
										@endif
									</div>
								</div>
								<div class="col-md-6">

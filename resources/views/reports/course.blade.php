		...
		<div class="toolbar" id="kt_toolbar">
			...
			<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
				...
				<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
					<!--begin::Title-->
					<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Course Report</h1>
					<!--end::Title-->
				</div>
				<!--end::Page title-->
					...
					<div class="card-header py-5 gap-2 gap-md-5">
						...
						<form id="bookingForm" method="GET" action="">
							<div class="row">
								...
								<div class="col-md-3 mb-3">
									<div class="d-flex align-items-center position-relative">
										<select name="course" id="course" class="form-control form-control-solid ps-14">
				                            <option value="">Select Course</option>
				                            @foreach($courses as $in)
			                                    <option value="{{$in->id}}">{{$in->course_name}}</option>
			                                @endforeach
				                        </select>
									</div>
								</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			function getTable(page = 1){
				...
				$.ajax({
	                url:"{{ url('report/course/get') }}",
	                data: { date_from:date_from, date_to:date_to, course:course },
	                type:"GET",

		...
		<div class="toolbar" id="kt_toolbar">
			...
			<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
				...
				<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
					<!--begin::Title-->
					<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Institution Course Report</h1>
					<!--end::Title-->
				</div>
				<!--end::Page title-->
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			function getTable(page = 1){
				...
				$.ajax({
	                url:"{{ url('report/institution-course/get') }}",
	                data: { date_from:date_from, date_to:date_to, subscription_id:subscription_id, category:category,  page:page, institution: institution },
	                type:"GET",
		...
		$(document).on("click", "#excelexport", function(){
			...
			var institution = $('#institution').val();
			var category = $('#category').val();
	        var url = "/report/institution-course/excel";
	        url = url+'?';
	        if(date_from != ''){

			...
			<div id="kt_content_container" class="container-xxl">
				...
				<div class="card card-flush">
					<div class="card-body">
						...
						<form action="{{url('/employees/'.$record->id)}}" method="POST">
							@method('patch')
							@csrf
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="name" class="form-control mb-2" placeholder="name" value="{{$record->name}}">
										@if($errors->has("name"))
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="designation" class="form-control mb-2" placeholder="Designation" value="{{$record->designation}}">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<br>
										<input type="radio" name="gender" value="Male" @if($record->gender == 'Male') checked="checked" @endif>  Male &nbsp;
										<input type="radio" name="gender" value="Female" @if($record->gender == 'Female') checked="checked" @endif>  Female 
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="mobile" class="form-control mb-2" placeholder="Mobile" value="{{$record->mobile}}">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="mobile2" class="form-control mb-2" placeholder="Alernative Mobile" value="{{$record->mobile2}}">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label class="required form-label">Email</label>
										<input type="text" name="email" class="form-control mb-2" placeholder="Email Address" value="{{$record->email}}">
										@if($errors->has("email"))
									...
									<div class="form-group">
										...
										<select name="dept" aria-label="Select Department" data-control="select2" data-placeholder="Select Department" class="form-select form-select-solid form-select-lg fw-bold">
											...
											@foreach($departments as $dept)
												<option  value="{{$dept->id}}" @if($record->dept == $dept->id) selected="selected" @endif>{{$dept->name}}</option>
											@endforeach
										</select>
										@if($errors->has("dept"))
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="dob" id="dob" class="form-control mb-2" placeholder="Date of Birth" value="{{date('d-m-Y', strtotime($record->date_birth))}}" autocomplete="off">
										@if($errors->has("dob"))
							...
							<div class="d-flex justify-content-end py-6">
								...
								<button type="button" class="btn btn-primary" id="kt_account_profile_details_submit">Update Changes</button>
							</div>
						</form>
					</div>
				</div>

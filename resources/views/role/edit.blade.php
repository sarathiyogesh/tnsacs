										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="text" class="form-control form-control-solid" placeholder="enter role name" name="name" id="name" value="{{$record->name}}" />
												</div>
											</div>
														...
														<tbody>
															@foreach($permissions as $per)
																<tr>
																	<td>
																		<div class="form-check form-check-sm form-check-custom form-check-solid">
																		<input class="form-check-input perMissions" type="checkbox" name="permission[]" value="{{$per->id}}" id="permission" @if(in_array($per->id, $permitted)) checked="checked" @endif >
																	</div>
																	</td>
																	<td>{{ $per->name }}</td>
																</tr>

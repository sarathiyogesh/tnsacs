		...
		@if(count($records) > 0)
			...
			@foreach($records as $record)
				<tr>
					...
					<td>
						<a href="javascript:;" class="editCategoryBtn" data-id="{{ $record->id }}" data-val="{{$record->name}}"><i class="las la-edit fs-4 text-red"></i> Edit</a>
						<span class="px-3 text-black-50">|</span>
						<a href="javascript:;" data-id="{{ $record->id }}" class="deleteCategoryBtn"><i class="las la-trash fs-4 text-red"></i> Delete</a>
					</td>
				</tr>
			@endforeach
		@else

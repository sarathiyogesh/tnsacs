		...
		<div class="toolbar" id="kt_toolbar">
			...
			<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
				...
				<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
					<!--begin::Title-->
					<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Edit Event</h1>
					<!--end::Title-->
				</div>
				<!--end::Page title-->
				<!--begin::Actions-->
					...
					<div class="card-body">
						...
						<form id="addEventForm">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="name" class="form-control mb-2" placeholder="Event Name" id="name" value="{{$record->name}}">
										@if($errors->has("name"))
									...
									<div class="form-group">
										...
										<select name="category" aria-label="Select category" data-control="select2" data-placeholder="Select category" class="form-select form-select-solid form-select-lg fw-bold" id="category">
											...
											@foreach($categories as $cat)
												<option value="{{$cat->id}}" @if($cat->id == $record->category) selected="selected" @endif >{{$cat->name}}</option>
											@endforeach
									...
									<div class="form-group">
										...
										<select name="country" aria-label="Select country" data-control="select2" data-placeholder="Select country" class="form-select form-select-solid form-select-lg fw-bold" id="country">
											...
											@foreach($countries as $country)
												<option value="{{$country->id}}" @if($country->id == $record->country) selected="selected" @endif >{{$country->country_name}}</option>
											@endforeach
									...
									<div class="form-group">
										...
										<select name="city" aria-label="Select city" data-control="select2" data-placeholder="Select city" class="form-select form-select-solid form-select-lg fw-bold" id="city">
											...
											@foreach($cities as $city)
												<option value="{{$city->id}}" @if($city->id == $record->city) selected="selected" @endif >{{$city->name}}</option>
											@endforeach
									...
									<div class="form-group">
										...
										<select name="language" aria-label="Select language" data-control="select2" data-placeholder="Select language" class="form-select form-select-solid form-select-lg fw-bold"  id="language">
											...
											@foreach($languages as $lan)
												<option value="{{$lan->id}}" @if($lan->id == $record->language) selected="selected" @endif >{{$lan->name}}</option>
											@endforeach
										</select>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="location" class="form-control mb-2" placeholder="Event Location" id="location" value="{{$record->location}}">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="address" class="form-control mb-2" placeholder="Address" id="address" value="{{$record->address}}">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="start_date" class="form-control mb-2" placeholder="Start Date" id="start_date" autocomplete="off" value="{{date('d-m-Y', strtotime($record->start_date))}}">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="end_date" class="form-control mb-2" placeholder="End Date" id="end_date" autocomplete="off" value="{{date('d-m-Y', strtotime($record->end_date))}}">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="price" class="form-control mb-2" placeholder="Price" id="price" value="{{$record->price}}">
										@if($errors->has("price"))
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="api_code" class="form-control mb-2" placeholder="API CODE" id="api_code" value="{{$record->api_code}}">
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<textarea name="description" id="description" class="form-control mb-2" rows="3">{!! $record->description !!}</textarea>
								...
								<div class="col-md-6 featureImgDiv mb-15">
									<div class="form-group">
										...
										<img class="featuredimage featured-image" src=" {{URL::asset($record->feature_image)}}">

									</div>
								</div>

								<div class="col-md-6 bannerImgDiv mb-15">
									<div class="form-group">
										...
										<img class="bannerimage featured-image" src="{{URL::asset($record->banner_image)}}">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="header_tag" class="form-control mb-2" placeholder="Header Tag" id="header_tag" value="{{$record->header_tag}}">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="meta_title" class="form-control mb-2" placeholder="Meta Title" id="meta_title" value="{{$record->meta_title}}">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="meta_description" class="form-control mb-2" placeholder="Meta Description" id="meta_description" value="{{$record->meta_description}}">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="meta_keywords" class="form-control mb-2" placeholder="Meta Keywords" id="meta_keywords" value="{{$record->meta_keywords}}">
								...
								<div class="col-md-6 metaImgDiv mb-15">
									<div class="form-group">
										...
										<img class=" featured-image metaimage" src=" {{URL::asset($record->meta_image)}}">
							...
							<div class="d-flex justify-content-end py-6">
								...
								<button type="button" class="btn btn-primary saveBtn" id="kt_account_profile_details_submit">Update </button>
							</div>
						</form>
					</div>
				</div>

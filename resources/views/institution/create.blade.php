		...
		<div class="toolbar" id="kt_toolbar">
			...
			<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
				...
				<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
					<!--begin::Title-->
					<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Add Institution</h1>
					<!--end::Title-->
				</div>
				<!--end::Page title-->
				<!--begin::Actions-->
				<div class="d-flex align-items-center gap-2 gap-lg-3">
					<a href="{{url('institution/manage')}}" id="kt_help_toggle" class="btn btn-sm btn-primary" >Manage Institutions</a>
				</div>
				<!--end::Actions-->
			</div>
			<!--end::Container-->
			...
			<div id="kt_content_container" class="container-xxl">
				...
				<div class="card card-flush">
					<div class="card-body">
						...
						<form action="/institution/create" class="selectiveForm" method="POST" enctype="multipart/form-data">
							@csrf
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="password" class="form-control mb-2" placeholder="Password" value="{{old('password')}}">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="confirm_password" class="form-control mb-2" placeholder="Confirm Password" value="{{old('confirm_password')}}">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" name="mobile" class="form-control mb-2" placeholder="Contact Number" value="{{old('mobile')}}">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" name="mobile2" class="form-control mb-2" placeholder="Alternate Contact Number" value="{{old('mobile2')}}">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="contact_person_name" class="form-control mb-2" placeholder="Name" value="{{old('contact_person_name')}}">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="contact_person_mobile" class="form-control mb-2" placeholder="Mobile" value="{{old('contact_person_mobile')}}">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" name="pincode" class="form-control mb-2" placeholder="Pincode" value="{{old('pincode')}}">

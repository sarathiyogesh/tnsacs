				...
				<div class="card card-flush">
					<div class="card-body">
						...
						<form action="{{ route('faq.update')}}" method="POST">
							@csrf
							<input type="hidden" name="editid" value="{{ $records->id }}">
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label class="required form-label">Question</label>
										<input type="text" name="question" class="form-control mb-2" placeholder="Question" value="{{old('question', $records->question) }}">
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<textarea class="form-control mb-2"  name="answer">{{old('answer', $records->answer) }}</textarea>
									...
									<div class="form-group">
										...
										<select class="form-control mb-2"  name="status" >
											...
											<option value="active"  @if(old('status', $records->status) == 'active') selected @endif>Active</option>
											<option value="inactive"@if(old('status', $records->status) == 'inactive') selected @endif>Inactive</option>
										</select>

			...
			<div id="kt_content_container" class="container-xxl">
				<div class="card card-flush">
					<div class="card-body">
						...
						<form action="{{url('/partner/offercode/update')}}" method="POST">
							@csrf
							<input type="hidden" name="editId" id="editId" value="{{$offerrec->id}}">
							<div class="row">
									...
									<div class="form-group">
										...
										<select name="partner" id="partner" aria-label="Select" data-control="select2" data-placeholder="Select" class="form-select form-select-solid form-select-lg fw-bold">
											<option value="">Select</option>
												...
												<option data-type="{{$par->offer_type}}" value="{{$par->id}}" <?php if($offerrec->partner_id == $par->id){ echo 'selected'; } ?>>
													{{$par->partner_name}} ({{$par->offer_type=='bank'?'BIN':'Code'}})
													</option>
												@endforeach
										</select>
								...
								<div class="col-md-6" id="singleCodeBox">
									<div class="form-group">
										...
										<input type="text" name="offerCode" class="form-control mb-2" placeholder="Partner Name" value="{{ $offerrec->offer_code }}">
								...
								<div class="col-md-6" id="cardTypeBox" style="display:none;">
									<div class="form-group">
										...
										<input type="text" name="cardType" class="form-control mb-2" placeholder="Card Type" value="{{ $offerrec->bank_card_type }}">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<select id="status" name="status" class="form-control">
											<option value="1" <?php if($offerrec->status == '1'){ echo 'selected'; } ?>>Active</option>
											<option value="0" <?php if($offerrec->status == '0'){ echo 'selected'; } ?>>Inactive</option>
										</select>

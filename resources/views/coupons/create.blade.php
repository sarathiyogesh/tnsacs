							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<select name="applied_to" aria-label="Select " data-control="select2" data-placeholder="Select " class="form-select form-select-solid form-select-lg fw-bold" id="applied_to">
											<option value="single" selected>No</option>
								...
								<div class="row d-flex align-items-center CouponDiv">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<select name="coupon_type" aria-label="Select "  data-placeholder="Select " class="form-select form-select-solid form-select-lg fw-bold coupontype" id="coupon_type">
												...
												<option value="special">Second Price</option>
											</select>
									...
									<div class="col-md-3 couponTypeTextDiv">
										<div class="form-group">
											<label class="required form-label couponTypeText">Amount</label>
											<input type="text" name="coupon_value" class="form-control mb-2 couponvalue" placeholder="" id="coupon_value" >
									...
									<div class="col-sm-2">
										...
										<a href="javascript:;" style="display:none;" class="btn btn-secondary btn-xs deleteService"><i class="las la-minus"></i> Delete</a>&nbsp;
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label class="required form-label">Coupon Name</label>
										<input type="text" name="couponname" class="form-control mb-2" placeholder="Coupon Name" value="{{old('couponname')}}" id="couponname">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="couponcode" class="form-control mb-2" placeholder="Coupon Code" value="{{old('couponcode')}}" id="couponcode">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="startdate" id="startdate" class="form-control mb-2" placeholder="Start Date" value="{{old('startdate')}}" autocomplete="off">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="enddate" id="enddate" class="form-control mb-2" placeholder="End Date" value="{{old('enddate')}}" autocomplete="off">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="minimumamount" class="form-control mb-2" placeholder="Minimum Order Amount" value="{{old('minimumamount')}}" id="minimumamount">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="totalcoupon" class="form-control mb-2" placeholder="Total Coupon" value="{{old('totalcoupon')}}" id="totalcoupon">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="usespercustomer" class="form-control mb-2" placeholder="Uses Per Customer" value="{{old('usespercustomer')}}" id="usespercustomer">
...
<script type="text/javascript">
	$(document).ready(function(){
	    ...
	    $(document).on('click', '.saveBtn', function(){
			...
			$.ajax({
                url: "/coupons",
                data: {activity:activity, coupon_type: coupon_type, coupon_value:coupon_value, applied_to:applied_to, couponname:couponname, couponcode:couponcode,startdate : startdate, enddate:enddate, minimumamount:minimumamount, totalcoupon:totalcoupon, usespercustomer:usespercustomer, status : status},
                type: 'POST',

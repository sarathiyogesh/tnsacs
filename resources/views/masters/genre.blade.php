...
@section('maincontent')
	...
	<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
		...
		<div class="toolbar" id="kt_toolbar">
			...
			<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
				...
				<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
					<!--begin::Title-->
					<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Manage Genre</h1>
					<!--end::Title-->
				</div>
				<!--end::Page title-->
				<!--begin::Actions-->
				@can('genre-add')
					<div class="d-flex align-items-center gap-2 gap-lg-3">
						<a href="javascript:;" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#addNewGenreModel">Add Genre</a>
					</div>
				@endcan
				<!--end::Actions-->
			</div>
						...
						<div class="row">
							<div class="col-md-3">
								<div class="d-flex align-items-center position-relative">
									...
									<input type="text" name="search_filter" id="search_filter" class="form-control form-control-solid ps-14" placeholder="Genre Name">
								</div>
							</div>
							<!-- <div class="col-md-2">
		...
		<!-- Modal -->
		<div class="modal fade" id="addNewGenreModel" tabindex="-1" aria-labelledby="addNewGenreModelLabel" aria-hidden="true">
		  <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
		    <div class="modal-content">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" name="genre_name" id="genre_name" class="form-control" placeholder="Genre Name" value="">
							</div>
						</div>
					</div>
				</div>
		      ...
		      <div class="modal-footer">
				<button type="button" class="btn btn-primary" id="saveGenre">Add</button>
		      </div>
		    </div>
		  </div>
		</div>
		...
		<div class="modal fade" id="editGenreModal" tabindex="-1" aria-labelledby="editGenreModalLabel" aria-hidden="true">
		  <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
		    <div class="modal-content">
				...
				<div class="card-body" id="kt_help_body">
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<label class="required form-label">Name</label>
								<input type="text" name="edit_genre_name" id="edit_genre_name" class="form-control" placeholder="Genre Name" value="">
							</div>
		      ...
		      <div class="modal-footer">
				<button type="button" class="btn btn-primary" id="updateGenre">Update</button>
		      </div>
		    </div>
		  </div>
		</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
				...
				$.ajax({
	                ...
	                success: function(res){
	                    ...
	                    if(res.status == 'success'){
	                    	alert('New genre created successfully');
	                    	$('#addNewGenreModel').modal('hide');
	                    	getTable();
			...
			$(document).on('click', '.editGenreBtn', function (){
				...
				$('#edit_genre_name').val($(this).attr('data-val'));
				$('#editGenreModal').modal('show');
			});

			$(document).on('click', '#updateGenre', function (){
				var data = $('#updategenreForm').serialize();
				var t = $(this); ctxt = t.text();
				t.text('Processing...').prop('disabled', true);
				$('.validation-errors').remove();
				$.ajax({
	                url:"{{ url('/master/genre/update') }}",
	                dataType: 'json',
					headers: { 'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content'), },
	                data: data,
	                type:"POST",

		...
		<div class="toolbar" id="kt_toolbar">
			...
			<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
				...
				<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
					<!--begin::Title-->
					<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Manage Course Subscriptions</h1>
					<!--end::Title-->
				</div>
				<!--end::Page title-->
				<!--begin::Actions-->
				...
				<div class="card card-flush mb-4 selectiveForm">
					<div class="card-header py-5 gap-2 gap-md-5">
						...
						<div class="row">
							...
							<div class="col-md-2">
								<div class="selectDiv">
									<select name="institution" id="institution" class="form-control form-select-solid" data-control="select2">
										<option value="">Institution</option>
										@foreach($institutions as $sub)
											<option value="{{$sub->id}}" <?php if(old('institution') == $sub->id){ echo 'selected'; } ?>>{{$sub->name}}</option>
										@endforeach
									</select>
								</div>
							</div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			function getTable(){
				...
				$.ajax({
	                url:"{{ url('/courses/purchased') }}",
	                data: { search:search,category:category,subject:subject,status:status,page:page, institution: institution },
	                type:"GET",

    ...
    function init_classic_menu(){
        ...
        $(window).scroll(function(){        
            ...
            if ($(window).scrollTop() > 10) {
                ...
                $(".main-nav, .nav-logo-wrap .logo, .inner-nav-logo, .mobile-nav").addClass("small-height");
            }
            else {
                $(".js-transparent").addClass("transparent");
                $(".main-nav, .nav-logo-wrap .logo, .inner-nav-logo, .mobile-nav").removeClass("small-height");
            }
...
function initPageSliders(){
    (function($){
        ...
        $(".item-carousel").owlCarousel({
            ...
            lazyLoad: true,
            addClassActive : true,
            navigationText: ["<span class='sr-only'>Previous Slide</span><i class='las la-arrow-left' aria-hidden='true'></i>", "<span class='sr-only'>Next Slide</span><i class='las la-arrow-right' aria-hidden='true'></i>"],
            afterInit: owl_keynav,
            afterAction: owl_update
        });
